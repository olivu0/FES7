...
// isNaN() 함수는 어떤 값이 숫자가 아닌지 인지 판별한다
// 숫자로 판별되는 것들은 false를 반환하고
// 숫자로 판별되지 않는 것들은 true를 반환한다
...
// isNaN은 내부적으로 Number()함수를 사용한다
// Number() 함수는 인수를 숫자로 변환할 수 없으면 NaN을 반환합니다.
// 활용법
// https://school.programmers.co.kr/learn/courses/30/lessons/120850
// "p2o4i8gj2"

// isNaN()은 Number로 숫자변환이 가능한 값을 false로 준다
...
let sum = 0;
/* if (value[0]) {
  sum += value[0]; // true여서 실행됨 => 실행되면 안됨
}; */
if (!isNaN(value[0])) {
...
/* 
Type(x)가 NaN이면 false를 반환합니다.(뒤에가 무엇이든지 false) y가 NaN이면 false를 반환합니다. 이것은 알고리즘이 먼저 피연산자 중하나가 NaN유형을 확인하기 전에 있는지 확인하고 그렇다면 false어쨌든 반환할 것임을 의미합니다.
*/
